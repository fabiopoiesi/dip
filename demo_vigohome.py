...
print('*****************************')
print('demo VigoHome dataset')
print('*****************************')

print('point clouds in their original reference frame ...')
print('... press \'q\' to continue ...')

pcd1 = o3d.io.read_point_cloud('assets/vigohome_bathroom_upstairs.ply')
pcd2 = o3d.io.read_point_cloud('assets/vigohome_livingroom_downstairs.ply')
